...
INSERT INTO tb_instrument (tag, serie, mark, description, type, range, frequency, last_calibration, status, note, department_id) VALUES ('52.34.00038', 'Manometro Digital Tex', '12345', 'Wika', 'Manometro', '0 a 16 bar', '12 meses', TIMESTAMP WITH TIME ZONE '2020-11-03T13:00:00Z', 1, 'Atualizado', 1); 
INSERT INTO tb_instrument (tag, serie, mark, description, type, range, frequency, last_calibration, status, note, department_id) VALUES ('52.01.30021', 'Paquímetro Analógico', '6789', 'Record', 'Paquímetro', '0 a 200 mm', '6 meses', TIMESTAMP WITH TIME ZONE '2020-11-03T13:00:00Z', 1, 'Reativado', 2); 
