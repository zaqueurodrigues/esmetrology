...
INSERT INTO tb_instrument (tag, description, type, range, frequency, last_calibration, status, note, department_id) VALUES ('52.01.30021', 'Paquímetro Analógico', 'Paquímetro', '0 a 200 mm', '6 meses', TIMESTAMP WITH TIME ZONE '2020-11-03T13:00:00Z', 1, 'Reativado', 2); 
